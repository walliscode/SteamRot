...
**Naming**: Use the pattern `<test_name>.test_data.json` (e.g., `ui_button_click.test_data.json`). For detailed naming conventions, see [Test Data Naming Conventions](../testing/TEST_DATA_NAMING_CONVENTIONS.md).
