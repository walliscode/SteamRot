...
PathProvider::PathProvider(EnvironmentType env_type) {
  ...
  if (env_type == EnvironmentType::None &&
    ...
    throw std::invalid_argument(
        ...
        "Please intialise the PathProvider with a valid EnvironmentType.");
...
PathProvider::GetDataDirectory() const {
  ...
  case EnvironmentType::Test:
    return std::filesystem::path{"/home/runner/work/SteamRot/SteamRot"} / "tests" / "data";
  case EnvironmentType::Production:
    return std::filesystem::path{"/home/runner/work/SteamRot/SteamRot"} / "data";
  default:
...
/////////////////////////////////////////////////
std::expected<std::filesystem::path, FailInfo>
PathProvider::GetUIStylesDirectory() const {
  auto dataDirResult = GetDataDirectory();
  if (!dataDirResult.has_value()) {
    return std::unexpected(dataDirResult.error());
  }
  return dataDirResult.value() / "ui_styles";
}
} // namespace steamrot
