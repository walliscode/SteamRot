...
struct SubscriberConfigFbs;
struct SubscriberConfigFbsBuilder;

struct SubscriberConfigFbs FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SubscriberConfigFbsBuilder Builder;
...
template<> inline const steamrot::UserInputBitsetData *SubscriberConfigFbs::trigger_data_as<steamrot::UserInputBitsetData>() const {
  return trigger_data_as_UserInputBitsetData();
}

template<> inline const steamrot::SceneChangePacketData *SubscriberConfigFbs::trigger_data_as<steamrot::SceneChangePacketData>() const {
  return trigger_data_as_SceneChangePacketData();
}

template<> inline const steamrot::UserInterfaceNameData *SubscriberConfigFbs::trigger_data_as<steamrot::UserInterfaceNameData>() const {
  return trigger_data_as_UserInterfaceNameData();
}

struct SubscriberConfigFbsBuilder {
  typedef SubscriberConfigFbs Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_event_type_data(steamrot::EventType event_type_data) {
    fbb_.AddElement<uint64_t>(SubscriberConfigFbs::VT_EVENT_TYPE_DATA, static_cast<uint64_t>(event_type_data), 0);
  }
  void add_trigger_data_type(steamrot::EventDataData trigger_data_type) {
    fbb_.AddElement<uint8_t>(SubscriberConfigFbs::VT_TRIGGER_DATA_TYPE, static_cast<uint8_t>(trigger_data_type), 0);
  }
  void add_trigger_data(::flatbuffers::Offset<void> trigger_data) {
    fbb_.AddOffset(SubscriberConfigFbs::VT_TRIGGER_DATA, trigger_data);
  }
  void add_active(bool active) {
    fbb_.AddElement<uint8_t>(SubscriberConfigFbs::VT_ACTIVE, static_cast<uint8_t>(active), 0);
  }
  explicit SubscriberConfigFbsBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SubscriberConfigFbs> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SubscriberConfigFbs>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SubscriberConfigFbs> CreateSubscriberConfigFbs(
    ...
    bool active = false) {
  SubscriberConfigFbsBuilder builder_(_fbb);
