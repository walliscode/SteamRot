...
///
/// Subscribes to EventType::CAMERA on construction.  Each tick that a
/// CAMERA event is active the subscriber captures the CameraPayload and
/// applies its scroll delta to SceneContext::camera_state.
/////////////////////////////////////////////////
...
public:
  /////////////////////////////////////////////////
  /// @brief Constructor - registers the CAMERA subscriber.
  ///
