...
public:
  ...
  ///
  /// @param logic_context SceneContext object containing the context for the
  /// logic.
  /////////////////////////////////////////////////
  UIActionLogic(const SceneContext logic_context);
};
...
/// @param logic_context SceneContext containing scene entities and archetypes
/////////////////////////////////////////////////
