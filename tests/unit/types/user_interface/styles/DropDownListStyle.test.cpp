/////////////////////////////////////////////////
/// @file
/// @brief Unit test for the DropDownListStyle struct
/////////////////////////////////////////////////
...
TEST_CASE("DropDownListStyle - Default Constructor", "[DropDownListStyle]") {
  DropDownListStyle style;
  ...
  // check DropDownListStyle specific defaults
