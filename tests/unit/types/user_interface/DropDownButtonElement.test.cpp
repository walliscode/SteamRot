/////////////////////////////////////////////////
/// @file
/// @brief Unit tests for DropDownButtonElement type
/////////////////////////////////////////////////
...
TEST_CASE("DropDownButtonElement: Default Constructor", "[types]") {
  ...
  REQUIRE(button.is_expanded == false);
}

TEST_CASE("DropDownButtonElement: Clone Method", "[types]") {
  steamrot::DropDownButtonElement original;
  ...
  auto *cloned = dynamic_cast<steamrot::DropDownButtonElement *>(cloned_ptr.get());
