...
//
// TEST_CASE(
//     "subscriber_factory::CreateAndRegisterSubscribers creates subscribers "
...
//   sub1.m_trigger_event_type =
//   steamrot::EventType::EventType_EVENT_USER_INPUT; sub1.m_active = false;
//   subscribers_input.push_back(sub1);
//
//   steamrot::Subscriber sub2;
//   sub2.m_trigger_event_type =
//   steamrot::EventType::EventType_EVENT_USER_INPUT; sf::Event::KeyPressed
//   key_event; key_event.code = sf::Keyboard::Key::W; sub2.m_trigger_event_data
//   = steamrot::UserInputBitset{{key_event}}; sub2.m_active = true;
...
//   auto result =
//       steamrot::subscriber_factory::CreateSubscriber(subscribers_input);
//
//   if (!result.has_value())
...
//
// TEST_CASE(
//     "subscriber_factory::CreateAndRegisterSubscribers skips NONE event
//     types",
//     "[unit][subscriber_factory]") {
//   // create a mock EventHandler
//   steamrot::EventHandler mock_event_handler;
...
//
// TEST_CASE(
//     "subscriber_factory::CreateAndRegisterSubscribers handles empty vector",
//     "[unit][subscriber_factory]") {
//   // create a mock EventHandler
//   steamrot::EventHandler mock_event_handler;
//
