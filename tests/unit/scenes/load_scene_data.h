/////////////////////////////////////////////////
/// @file
/// @brief Functions to load test scene data from binary file
/////////////////////////////////////////////////
...
/////////////////////////////////////////////////
/// @brief Load scene test data from binary file
///
/// @return Pair of unique_ptr to data buffer and SceneDataFbs pointer
/////////////////////////////////////////////////
inline std::pair<std::unique_ptr<char[]>, const steamrot::SceneDataFbs *>
LoadSceneTestData() {
  std::filesystem::path test_file_path = __FILE__;
  std::filesystem::path data_dir = test_file_path.parent_path() / "data";
  std::filesystem::path bin_file_path = data_dir / "test_scene.scene_data.bin";
  ...
  const steamrot::SceneDataFbs *scene_data_fbs =
      steamrot::GetSceneDataFbs(data.get());

  return {std::move(data), scene_data_fbs};
}
