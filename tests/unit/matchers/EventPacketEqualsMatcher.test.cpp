...
TEST_CASE("EventPacketEqualsMatcher works correctly",
  ...
  expected.event_type = steamrot::EventType::EventType_EVENT_USER_INPUT;
  ...
  SECTION("Matcher detects differences in m_event_type") {
    actual.event_type = steamrot::EventType::EventType_EVENT_TEST;
  ...
  SECTION("Matcher detects differences in event_id") {
    actual.event_type = steamrot::EventType::EventType_EVENT_USER_INPUT;
