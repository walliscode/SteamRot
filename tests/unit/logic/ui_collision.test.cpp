...
TEST_CASE("IsMouseOverBounds returns false for point outside bounds",
  ...
  bool result =
      steamrot::logic::ui::collision::IsMouseOverBounds(mouse_position, bounds);
...
TEST_CASE("IsMouseOverBounds returns correct results for various bounds and "
  ...
  bool result = steamrot::logic::ui::collision::IsMouseOverBounds(cases.mouse_pos,
                                                              cases.bounds);
...
TEST_CASE("CheckMouseOverUIElement toggles Panel Element",
  ...
  steamrot::logic::ui::collision::CheckMouseOverUIElement(mouse_position,
                                                      panel_element);
...
TEST_CASE("CheckMouseOverNestedUIElement toggles nested Panel Elements",
  ...
  steamrot::logic::ui::collision::CheckMouseOverNestedUIElement(mouse_position,
                                                            parent_element);
