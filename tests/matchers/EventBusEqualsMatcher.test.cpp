...
TEST_CASE("EventBusEqualsMatcher works correctly",
  ...
  packet1.event_type = steamrot::EventType::EVENT_USER_INPUT;
  ...
  SECTION("Matcher detects differences in EventPacket") {
    ...
    packet2.event_type = steamrot::EventType::EVENT_TEST;
  ...
  SECTION("Matcher detects equality") {
    ...
    packet3.event_type = steamrot::EventType::EVENT_USER_INPUT;
...
TEST_CASE("EventBusEqualsMatcher describe is as expected on failure",
  ...
  packet.event_type = steamrot::EventType::EVENT_USER_INPUT;
