...
TEST_CASE("EventBusEqualsMatcher works correctly",
  ...
  packet1.m_event_type = steamrot::EventType::EVENT_USER_INPUT;
  ...
  SECTION("Matcher detects differences in EventPacket") {
    ...
    packet2.m_event_type = steamrot::EventType::EVENT_TEST;
  ...
  SECTION("Matcher detects equality") {
    ...
    packet3.m_event_type = steamrot::EventType::EVENT_USER_INPUT;
...
TEST_CASE("EventBusEqualsMatcher describe is as expected on failure",
  ...
  packet.m_event_type = steamrot::EventType::EVENT_USER_INPUT;
